...
public class SearchByLastNameViewController implements Initializable{
		//Attribute
		private Main main;
		...
		public SearchByLastNameViewController() {
		...
		void refreshData(ActionEvent e) {
			try {
				...
				if(main.thereArePeopleInSystem()== true) {
					...
					ObservableList<Person> aux = main.refreshData(input.toUpperCase(),1);
